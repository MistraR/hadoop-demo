package com.mistra.hadoop.hdfs;
...
public class HDFSWCApp02 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Properties properties = com.imooc.bigdata.hadoop.hdfs.ParamsUtils.getProperties();
        ...
        com.imooc.bigdata.hadoop.hdfs.ImoocMapper mapper = (com.imooc.bigdata.hadoop.hdfs.ImoocMapper)clazz.newInstance();


        //ImoocMapper mapper = new WordCountMapper();
        com.imooc.bigdata.hadoop.hdfs.ImoocContext context = new com.imooc.bigdata.hadoop.hdfs.ImoocContext();
